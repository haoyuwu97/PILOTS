...
std::unique_ptr<IMeasure> coordination_create(const IniConfig& cfg,
  ...
  const fs::path out = measure_ext::resolve_measure_output_path(cfg, section, env, "output", "coordination.dat");
...
std::unique_ptr<IMeasure> residence_create(const IniConfig& cfg,
  ...
  const fs::path out = measure_ext::resolve_measure_output_path(cfg, section, env, "output", "residence_acf.dat");
...
std::unique_ptr<IMeasure> box_stats_create(const IniConfig& cfg,
                                           ...
                                           const SystemContext& sysctx) {
  (void)sysctx;
  const fs::path out = measure_ext::resolve_measure_output_path(cfg, section, env, "output", "box_stats.dat");
